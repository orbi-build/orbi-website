...
function configuredCloudLoginUrl(value) {
  ...
  try {
    ...
    if (url.protocol !== "https:" || !url.hostname || url.pathname !== CLOUD_LOGIN_ROUTE) {
...
export { cloudLoginResponse, configuredCloudLoginUrl, field, fetchAsset, githubHeaders, handleFetch };
