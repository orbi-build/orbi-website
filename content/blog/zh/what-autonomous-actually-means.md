...
少有人展示的是拒绝：另一个东西读完 diff，判断这份代码不能发。下面这次交付真的发生过。
...
Orbi 采用 fair-code、源码可得并支持自托管：[github.com/orbi-build/orbi](https://github.com/orbi-build/orbi)。


## 相关

继续阅读：[Orca 对比](/zh/compare/orca/) 与 [Cloud](/zh/cloud/)。
