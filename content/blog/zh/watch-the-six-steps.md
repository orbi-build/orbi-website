...
<img src="/img/step-1-sign-in-2x.png" alt="Orbi Cloud 登录页面" width="2560" height="1440" srcset="/img/step-1-sign-in-2x.png 2x" sizes="(min-width: 900px) 784px, 100vw" loading="eager">
<figcaption>第 1 步：Orbi Cloud 登录页面。</figcaption>
</figure>

<figure class="post-media">
<img src="/img/step-2-install-app-2x.png" alt="GitHub App 安装页面" width="2560" height="1440" srcset="/img/step-2-install-app-2x.png 2x" sizes="(min-width: 900px) 784px, 100vw" loading="eager">
<figcaption>第 2 步：GitHub App 安装页面。</figcaption>
</figure>

<figure class="post-media">
<img src="/img/step-3-connect-repo-2x.png" alt="连接仓库表单" width="2560" height="1440" srcset="/img/step-3-connect-repo-2x.png 2x" sizes="(min-width: 900px) 784px, 100vw">
<figcaption>第 3 步：连接仓库表单。</figcaption>
</figure>

<figure class="post-media">
<img src="/img/step-4-provision-2x.png" alt="开通运行环境状态" width="2560" height="1440" srcset="/img/step-4-provision-2x.png 2x" sizes="(min-width: 900px) 784px, 100vw">
<figcaption>第 4 步：开通运行环境状态。</figcaption>
</figure>

<figure class="post-media">
<img src="/img/step-5-first-issue-2x.png" alt="第一个 Issue 的状态页面" width="2560" height="1440" srcset="/img/step-5-first-issue-2x.png 2x" sizes="(min-width: 900px) 784px, 100vw">
<figcaption>第 5 步：第一个 Issue 的状态页面。</figcaption>
</figure>

<figure class="post-media">
<img src="/img/step-6-release-2x.png" alt="填写版本号的发版表单" width="2560" height="1440" srcset="/img/step-6-release-2x.png 2x" sizes="(min-width: 900px) 784px, 100vw">
<figcaption>第 6 步：填写版本号的发版表单。</figcaption>
</figure>

<figure class="post-media">
<img src="/img/step-7-subscribe-2x.png" alt="Managed Cloud 订阅页面" width="2560" height="1440" srcset="/img/step-7-subscribe-2x.png 2x" sizes="(min-width: 900px) 784px, 100vw">
