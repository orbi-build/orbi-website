...
[Orbi](https://github.com/orbi-build/orbi) 就是我按这三条做的实现，open source (AGPL-3.0)，可以自己部署，而且它在自己身上跑：上面那 431 个 PR 全是公开的，每一轮评审结论也都在 Issue 的评论里，随便点开一张看。底下的引擎可以用 Claude Code、Codex 或者任何 OpenAI 兼容的模型，所以你现在的模型那一侧不用动。
